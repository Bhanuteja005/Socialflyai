...
import { FileText, GalleryHorizontal, Hash, ImageIcon, PenSquare, Wand2 } from "lucide-react";
			...
			<CardContent>
				{recent.isPending ? (
					...
					<EmptyState
						...
						description="Images, carousels and AI drafts you create show up here."
					/>
				) : (
