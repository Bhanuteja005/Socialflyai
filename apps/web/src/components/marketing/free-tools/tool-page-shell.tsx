...
import { Container, CtaLink, Eyebrow, focusRing, Glow, headingDisplay } from "../primitives";
	...
	return (
		<section className="relative overflow-hidden pt-28 pb-16 sm:pt-32 lg:pt-40 lg:pb-20">
			...
			<Container size="lg" className="relative">
				<Link
					href="/free-tools"
					className={`group mb-10 inline-flex items-center gap-2 rounded font-medium text-sm text-white/50 transition-colors hover:text-primary ${focusRing}`}
				>
					<ArrowLeft
				...
				<div className="mx-auto max-w-4xl text-center">
					<Eyebrow icon={badgeIcon} className="mb-8 uppercase tracking-wider">
						{badge}
					</Eyebrow>
...
export function ToolPromo() {
	return (
		<section aria-label="More from SocialFly AI" className="border-white/5 border-y py-10">
			<Container
				size="lg"
			...
			>
				...
				<div className="flex flex-col gap-3 sm:flex-row">
					...
					<CtaLink href="/signup" size="md" icon={ArrowRight}>
